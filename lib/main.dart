        ...
        switch (settings.name) {
          case "welcome_page":
            return FullscreenBackPageRoute(
                builder: (context) => WelcomePage(), settings: settings, maintainState: false);
          case "login_page":
          ...
          case "blocklist_page":
            return FullscreenBackPageRoute(
                builder: (context) => BlocklistPage(), settings: settings, maintainState: true);
          case "message_page":
            return FullscreenBackPageRoute(
          ...
          case "video_page":
            if (settings.arguments is String) {
              return FullscreenBackPageRoute(
                  builder: (context) => VideoPage(settings.arguments), settings: settings, maintainState: true);
            }
            return null;
          case "settings_page":
            return FullscreenBackPageRoute(
          ...
          case "collection_page":
            return FullscreenBackPageRoute(
                builder: (context) => CollectionPage(), settings: settings, maintainState: true);
          default:
            return null;
        }
      },
