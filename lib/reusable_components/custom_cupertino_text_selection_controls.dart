...
class CustomCupertinoTextSelectionControls extends TextSelectionControls {
  ...
  CustomCupertinoTextSelectionControls({@required this.canCancelTarget, @required this.cancelTarget});
  ...
  Widget buildToolbar(
    ...
    if (canCancelTarget() && cancelTarget != null) {
      items.add(CupertinoButton(
        child: Text("dismissReplyPointerTrans".tr, style: _kToolbarButtonFontStyle),
        color: _kToolbarBackgroundColor,
        minSize: _kToolbarHeight,
        padding: _kToolbarButtonPadding.add(arrowPadding),
        borderRadius: null,
