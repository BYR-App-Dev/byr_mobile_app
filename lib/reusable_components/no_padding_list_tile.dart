...
/// Defines the title font used for [ListTile] descendants of a [NonPaddingListTileTheme].
///
...
class NonPaddingListTileTheme extends InheritedWidget {
  /// Creates a list tile theme that controls the color and style parameters for
  /// [ListTile]s.
  const NonPaddingListTileTheme({
    Key key,
    this.dense = false,
    this.style = NonPaddingListTileStyle.list,
    this.selectedColor,
    this.iconColor,
    this.textColor,
    this.contentPadding,
  ...
  static Widget merge({
    ...
    return Builder(
      builder: (BuildContext context) {
        final NonPaddingListTileTheme parent = NonPaddingListTileTheme.of(context);
        return NonPaddingListTileTheme(
          key: key,
  ...
  final NonPaddingListTileStyle style;
  ...
  ///
  /// ```dart
  /// NonPaddingListTileTheme theme = NonPaddingListTileTheme.of(context);
  /// ```
  static NonPaddingListTileTheme of(BuildContext context) {
    final NonPaddingListTileTheme result = context.dependOnInheritedWidgetOfExactType<NonPaddingListTileTheme>();
    return result ?? const NonPaddingListTileTheme();
  }

  @override
  bool updateShouldNotify(NonPaddingListTileTheme oldWidget) {
...
/// See also:
///
///  * [NonPaddingListTileTheme], which defines visual properties for [ListTile]s.
...
class NonPaddingListTile extends StatelessWidget {
  /// Creates a list tile.
  ///
  /// If [isThreeLine] is true, then [subtitle] must not be null.
  ///
  /// Requires one of its ancestors to be a [Material] widget.
  const NonPaddingListTile({
    Key key,
    this.leading,
    this.title,
    this.subtitle,
  ...
  ///
  /// If this property is null then its value is based on [NonPaddingListTileTheme.dense].
  ///
  ...
  /// can be overridden with a [NonPaddingListTileTheme].
  final bool selected;
  ...
  Color _iconColor(ThemeData theme, NonPaddingListTileTheme tileTheme) {
  ...
  Color _textColor(ThemeData theme, NonPaddingListTileTheme tileTheme, Color defaultColor) {
    if (!enabled) return theme.disabledColor;
  ...
  bool _isDenseLayout(NonPaddingListTileTheme tileTheme) {
    return dense != null ? dense : (tileTheme?.dense ?? false);
  }

  TextStyle _titleTextStyle(ThemeData theme, NonPaddingListTileTheme tileTheme) {
    TextStyle style;
    if (tileTheme != null) {
      switch (tileTheme.style) {
        case NonPaddingListTileStyle.drawer:
          style = theme.textTheme.body2;
          break;
        case NonPaddingListTileStyle.list:
  ...
  TextStyle _subtitleTextStyle(ThemeData theme, NonPaddingListTileTheme tileTheme) {
  ...
  Widget build(BuildContext context) {
    ...
    final NonPaddingListTileTheme tileTheme = NonPaddingListTileTheme.of(context);
...
// Identifies the children of a _NonPaddingListTileElement.
enum _NonPaddingListTileSlot {
  leading,
  title,
  subtitle,
  trailing,
...
class _NonPaddingListTile extends RenderObjectWidget {
  const _NonPaddingListTile({
    Key key,
    this.leading,
    this.title,
    this.subtitle,
  ...
  @override
  _NonPaddingListTileElement createElement() => _NonPaddingListTileElement(this);

  @override
  _NonPaddingRenderListTile createRenderObject(BuildContext context) {
    return _NonPaddingRenderListTile(
      isThreeLine: isThreeLine,
      isDense: isDense,
      textDirection: textDirection,
  ...
  @override
  void updateRenderObject(BuildContext context, _NonPaddingRenderListTile renderObject) {
    renderObject
      ..isThreeLine = isThreeLine
      ..isDense = isDense
      ..textDirection = textDirection
...
class _NonPaddingListTileElement extends RenderObjectElement {
  _NonPaddingListTileElement(_NonPaddingListTile widget) : super(widget);

  final Map<_NonPaddingListTileSlot, Element> slotToChild = <_NonPaddingListTileSlot, Element>{};
  final Map<Element, _NonPaddingListTileSlot> childToSlot = <Element, _NonPaddingListTileSlot>{};

  @override
  _NonPaddingListTile get widget => super.widget;

  @override
  _NonPaddingRenderListTile get renderObject => super.renderObject;
  ...
  void forgetChild(Element child) {
    ...
    final _NonPaddingListTileSlot slot = childToSlot[child];
    childToSlot.remove(child);
    slotToChild.remove(slot);
  }

  void _mountChild(Widget widget, _NonPaddingListTileSlot slot) {
  ...
  void mount(Element parent, dynamic newSlot) {
    ...
    _mountChild(widget.leading, _NonPaddingListTileSlot.leading);
    _mountChild(widget.title, _NonPaddingListTileSlot.title);
    _mountChild(widget.subtitle, _NonPaddingListTileSlot.subtitle);
    _mountChild(widget.trailing, _NonPaddingListTileSlot.trailing);
  }

  void _updateChild(Widget widget, _NonPaddingListTileSlot slot) {
    final Element oldChild = slotToChild[slot];
    final Element newChild = updateChild(oldChild, widget, slot);
    if (oldChild != null) {
      childToSlot.remove(oldChild);
  ...
  @override
  void update(_NonPaddingListTile newWidget) {
    super.update(newWidget);
    assert(widget == newWidget);
    _updateChild(widget.leading, _NonPaddingListTileSlot.leading);
    _updateChild(widget.title, _NonPaddingListTileSlot.title);
    _updateChild(widget.subtitle, _NonPaddingListTileSlot.subtitle);
    _updateChild(widget.trailing, _NonPaddingListTileSlot.trailing);
  }

  void _updateRenderObject(RenderObject child, _NonPaddingListTileSlot slot) {
    switch (slot) {
      case _NonPaddingListTileSlot.leading:
        renderObject.leading = child;
        break;
      case _NonPaddingListTileSlot.title:
        renderObject.title = child;
        break;
      case _NonPaddingListTileSlot.subtitle:
        renderObject.subtitle = child;
        break;
      case _NonPaddingListTileSlot.trailing:
  ...
  void insertChildRenderObject(RenderObject child, dynamic slotValue) {
    ...
    assert(slotValue is _NonPaddingListTileSlot);
    final _NonPaddingListTileSlot slot = slotValue;
...
class _NonPaddingRenderListTile extends RenderBox {
  _NonPaddingRenderListTile({
  ...
  final Map<_NonPaddingListTileSlot, RenderBox> slotToChild = <_NonPaddingListTileSlot, RenderBox>{};
  final Map<RenderBox, _NonPaddingListTileSlot> childToSlot = <RenderBox, _NonPaddingListTileSlot>{};

  RenderBox _updateChild(RenderBox oldChild, RenderBox newChild, _NonPaddingListTileSlot slot) {
    if (oldChild != null) {
      dropChild(oldChild);
      childToSlot.remove(oldChild);
      slotToChild.remove(slot);
  ...
  set leading(RenderBox value) {
    _leading = _updateChild(_leading, value, _NonPaddingListTileSlot.leading);
  }

  RenderBox _title;
  RenderBox get title => _title;
  set title(RenderBox value) {
    _title = _updateChild(_title, value, _NonPaddingListTileSlot.title);
  }

  RenderBox _subtitle;
  RenderBox get subtitle => _subtitle;
  set subtitle(RenderBox value) {
    _subtitle = _updateChild(_subtitle, value, _NonPaddingListTileSlot.subtitle);
  }

  RenderBox _trailing;
  RenderBox get trailing => _trailing;
  set trailing(RenderBox value) {
    _trailing = _updateChild(_trailing, value, _NonPaddingListTileSlot.trailing);
  }
