...
class _ExtendedMaterialTextSelectionToolbar extends StatelessWidget {
  const _ExtendedMaterialTextSelectionToolbar({
    Key key,
    this.handleCut,
    this.handleCopy,
    this.handlePaste,
...
class CustomMaterialTextSelectionControls extends TextSelectionControls {
  ...
  final VoidCallback cancelTarget;
  CustomMaterialTextSelectionControls({@required this.canCancelTarget, @required this.cancelTarget});
  ...
  Widget buildToolbar(
    ...
    return ConstrainedBox(
      ...
      child: CustomSingleChildLayout(
        ...
        child: _ExtendedMaterialTextSelectionToolbar(
