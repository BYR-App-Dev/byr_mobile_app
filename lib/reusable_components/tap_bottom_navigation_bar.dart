...
class TapBottomNavigationBar extends StatefulWidget {
  ...
  final Function(int newValue, int oldValue) onTap;
...
class _BottomNavigationBarState extends State<TapBottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(TapBottomNavigationBar oldWidget) {
  ...
  List<Widget> _createTiles() {
    ...
    for (int i = 0; i < widget.items.length; i++) {
      tiles.add(_BottomNavigationTile(
        ...
        onTap: () {
          if (widget.onTap != null) widget.onTap(i, widget.currentIndex);
        },
        colorTween: colorTween,
