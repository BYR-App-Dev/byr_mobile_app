...
class CustomTabController extends ChangeNotifier {
  ...
  CustomTabController({int initialIndex = 0, @required this.length, @required TickerProvider vsync})
  ...
  CustomTabController _copyWith({int index, int length, int previousIndex}) {
